  ...
  render() {
    ...
    return (
      <div className='createRecipe'>
        <h1 className='createTitle'>Create your own recipe!</h1>
          ...
          <div>
            <form action="submit" onSubmit={this.addToList} className='createForm'>
              ...
              <div className='ingAmount'>
                ...
                <input className='amount' type="number" min='0' name='ingredientAmount' onChange={this._change} value={this.state.ingredientAmount}/>
                <select id='ingredientMeasure' name="ingredientMeasure" onChange={this._change}>
